          ...
          <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex">
            ...
            <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-16 xl:px-24">
              <div className="max-w-lg">
                ...
                >
                  <span
                    className={`inline-flex items-center gap-2 px-4 py-2 text-[11px] font-bold tracking-[0.2em] uppercase border-l-4 ${isDark
                ...
                {/* Headline */}
                <h1
                  className={`mt-6 text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.1] tracking-tight ${isDark ? 'text-white' : 'text-brown'
                    }`}
                ...
                <motion.p
                  ...
                  className={`mt-6 text-lg leading-relaxed max-w-md border-l border-opacity-30 pl-4 italic ${isDark ? 'text-cream/70 border-cream' : 'text-brown-light border-brown-light'
                    }`}
                  style={{ fontFamily: 'Georgia, serif' }}
                >
                  {subtext}
                ...
                >
                  <motion.button
                    ...
                    className={`group px-8 py-4 font-bold text-sm uppercase tracking-widest flex items-center gap-2 transition-all duration-300 rounded-xl ${isDark
                  ...
                  >
                    {primaryCta.label}
                    <ArrowRight01Icon size={16} strokeWidth={2.5} className="group-hover:translate-x-1 transition-transform" />
                  </motion.button>

                  {secondaryCta && (
                    <motion.button
                      onClick={() => handleCta(secondaryCta)}
                      className={`px-8 py-4 font-bold text-sm uppercase tracking-widest border-2 transition-all duration-300 rounded-xl ${isDark
