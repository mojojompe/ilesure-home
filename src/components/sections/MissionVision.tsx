...
const cards = [
  {
    ...
    icon: Target,
    eyebrow: 'Our Mission',
    title: 'Eliminate housing insecurity for Nigerian Users',
    body: 'We exist to replace the informal, chaotic off-destination housing market with a transparent, trustworthy, and data-rich platform, starting with Nigeria and scaling across Nigeria. Every User deserves to find a safe, verified home without risking their money or their peace of mind.',
    accent: '#C9962A',
  ...
  },
  {
    ...
    body: "We envision a future where any Nigerian university User, whether in Nigeria, Lagos, Abuja, or Port Harcourt, can find a verified, compatible, affordable home with one search. iléSure will be the home discovery layer for every User's university journey.",
    accent: '#5C3317',
