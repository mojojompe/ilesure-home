...
export function HowItWorks() {  const lineRef = useRef<SVGPathElement>(null);
  ...
  return (
    <section id="how-it-works" ref={sectionRef} className="py-20 bg-cream relative overflow-hidden">
