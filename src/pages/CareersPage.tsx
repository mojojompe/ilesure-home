...
export function CareersPage() {
  useSEO({
    title: 'Careers at iléSure',
    description: 'Join our mission to revolutionize student housing and real estate in Africa.',
    canonical: '/careers',
  });
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 py-32 sm:py-40 relative z-10">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-brown-400">
            Join our mission to revolutionize student housing and real estate in Africa.
          </p>
          <div className="pt-8">
            <div className="clay-card p-8">
              <h3 className="text-xl font-bold text-brown mb-2">Check back later</h3>
              <p className="text-brown-400">Open positions will be listed here soon!</p>
            </div>
          </div>
        </motion.div>
      </main>
