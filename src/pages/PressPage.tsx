...
export function PressPage() {
  useSEO({
    title: 'Press & Media',
    description: 'Latest news, press releases, and media resources for iléSure.',
    canonical: '/press',
  });
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 py-32 sm:py-40 relative z-10">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-brown-400">
            Latest news, press releases, and media resources for iléSure.
          </p>
          <div className="pt-8">
            <div className="clay-card p-8">
              <h3 className="text-xl font-bold text-brown mb-2">Check back later</h3>
              <p className="text-brown-400">Press kit coming soon!</p>
            </div>
          </div>
        </motion.div>
      </main>
