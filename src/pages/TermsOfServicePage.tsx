      ...
      <PolicyLayout title="Terms of Service" lastUpdated={lastUpdated} toc={toc}>
        ...
        <section id="service-description" className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed mt-4">
            iléSure operates as a marketplace connecting students with housing agents and potential roommates. We do not own, manage, or lease any properties listed on the Platform.
          </p>
        </section>
