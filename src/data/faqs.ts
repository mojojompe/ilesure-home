...
export const faqs: FAQ[] = [
  {
    ...
    answer: "iléSure (Yoruba for \"Sure Home\") is a student-focused housing discovery and roommate matching platform built for the off-campus accommodation ecosystem around Lead City University and other universities in Nigeria. We connect students with verified landlords, agents, and potential roommates.",
  },
  {
    id: 'faq2',
  ...
  },
  {
    ...
    answer: 'We currently focus on the Lead City University corridor, Toll Gate, Soka, Felele, New Garage and Akala Express, and surrounding areas in Nigeria. We are actively expanding to cover UI, Polytechnic areas, and beyond in 2026.',
  },
  {
    id: 'faq6',
