...
export const testimonials: Testimonial[] = [
  {
    ...
    quote: 'IleSure helped me find a verified self-con just 5 minutes from school within 3 days. The distance info and power ratings were spot on!',
    rating: 5,
    initials: 'AO',
    avatarColor: '#C9962A',
  },
  ...
  },
  {
    ...
    role: '100L, Medicine',
    university: 'Lead City University',
    quote: 'As a fresher, I had no idea how to find a safe place near campus. IleSure made it easy, verified agents, clear pricing, no hidden fees.',
    rating: 5,
    initials: 'FB',
    avatarColor: '#5C3317',
  },
